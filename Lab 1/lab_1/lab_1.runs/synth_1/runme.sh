...
HD_PWD='C:/Users/Mustafa/lab_1/lab_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log model_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source model_4.tcl
