...
################################################################
# This is a generated script based on design: questionC
#
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net EN_1 [get_bd_ports EN] [get_bd_pins xup_and2_0/b] [get_bd_pins xup_and2_1/b]
  connect_bd_net -net X0_1 [get_bd_ports X0] [get_bd_pins xup_and2_1/a] [get_bd_pins xup_inv_0/a]
  ...
  connect_bd_net -net decoder2to4_wrapper_0_D0 [get_bd_ports Y0] [get_bd_pins decoder2to4_wrapper_0/D0]
  connect_bd_net -net decoder2to4_wrapper_0_D1 [get_bd_ports Y1] [get_bd_pins decoder2to4_wrapper_0/D1]
  connect_bd_net -net decoder2to4_wrapper_0_D2 [get_bd_ports Y2] [get_bd_pins decoder2to4_wrapper_0/D2]
  connect_bd_net -net decoder2to4_wrapper_0_D3 [get_bd_ports Y3] [get_bd_pins decoder2to4_wrapper_0/D3]
  connect_bd_net -net decoder2to4_wrapper_1_D0 [get_bd_ports Y4] [get_bd_pins decoder2to4_wrapper_1/D0]
  connect_bd_net -net decoder2to4_wrapper_1_D1 [get_bd_ports Y5] [get_bd_pins decoder2to4_wrapper_1/D1]
  connect_bd_net -net decoder2to4_wrapper_1_D2 [get_bd_ports Y6] [get_bd_pins decoder2to4_wrapper_1/D2]
  connect_bd_net -net decoder2to4_wrapper_1_D3 [get_bd_ports Y7] [get_bd_pins decoder2to4_wrapper_1/D3]
  connect_bd_net -net xup_and2_0_y [get_bd_pins decoder2to4_wrapper_0/EN] [get_bd_pins xup_and2_0/y]
  connect_bd_net -net xup_and2_1_y [get_bd_pins decoder2to4_wrapper_1/EN] [get_bd_pins xup_and2_1/y]
