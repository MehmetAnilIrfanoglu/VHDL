...
################################################################
# This is a generated script based on design: questionA
#
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins xup_dff_en_reset_0/clk] [get_bd_pins xup_dff_en_reset_1/clk] [get_bd_pins xup_dff_en_reset_2/clk] [get_bd_pins xup_dff_en_reset_3/clk]
  connect_bd_net -net en_1 [get_bd_ports en] [get_bd_pins xup_dff_en_reset_0/en] [get_bd_pins xup_dff_en_reset_1/en] [get_bd_pins xup_dff_en_reset_2/en] [get_bd_pins xup_dff_en_reset_3/en]
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins xup_dff_en_reset_0/reset] [get_bd_pins xup_dff_en_reset_1/reset] [get_bd_pins xup_dff_en_reset_2/reset] [get_bd_pins xup_dff_en_reset_3/reset]
  connect_bd_net -net xup_and2_0_y [get_bd_pins xup_and2_0/y] [get_bd_pins xup_xor2_0/a]
  connect_bd_net -net xup_and2_1_y [get_bd_pins xup_and2_1/y] [get_bd_pins xup_and2_3/b] [get_bd_pins xup_xor2_1/a]
  ...
  connect_bd_net -net xup_and2_4_y [get_bd_ports CO] [get_bd_pins xup_and2_4/y]
  connect_bd_net -net xup_dff_en_reset_0_q [get_bd_ports Q0] [get_bd_pins xup_and2_0/b] [get_bd_pins xup_and2_1/a] [get_bd_pins xup_and2_4/a] [get_bd_pins xup_dff_en_reset_0/q] [get_bd_pins xup_inv_0/a]
  connect_bd_net -net xup_dff_en_reset_1_q [get_bd_ports Q1] [get_bd_pins xup_and2_1/b] [get_bd_pins xup_dff_en_reset_1/q] [get_bd_pins xup_xor2_0/b]
  connect_bd_net -net xup_dff_en_reset_2_q [get_bd_ports Q2] [get_bd_pins xup_and2_3/a] [get_bd_pins xup_dff_en_reset_2/q] [get_bd_pins xup_xor2_1/b]
  connect_bd_net -net xup_dff_en_reset_3_q [get_bd_ports Q3] [get_bd_pins xup_and2_2/a] [get_bd_pins xup_and2_4/b] [get_bd_pins xup_dff_en_reset_3/q] [get_bd_pins xup_inv_1/a]
  connect_bd_net -net xup_inv_0_y [get_bd_pins xup_and2_2/b] [get_bd_pins xup_dff_en_reset_0/d] [get_bd_pins xup_inv_0/y]
  connect_bd_net -net xup_inv_1_y [get_bd_pins xup_and2_0/a] [get_bd_pins xup_inv_1/y]
  connect_bd_net -net xup_or2_0_y [get_bd_pins xup_dff_en_reset_3/d] [get_bd_pins xup_or2_0/y]
  connect_bd_net -net xup_xor2_0_y [get_bd_pins xup_dff_en_reset_1/d] [get_bd_pins xup_xor2_0/y]
  connect_bd_net -net xup_xor2_1_y [get_bd_pins xup_dff_en_reset_2/d] [get_bd_pins xup_xor2_1/y]
